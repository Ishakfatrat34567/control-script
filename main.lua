...
subtitle.Text = "Click players to auth/unauth. Commands: /follow /orbit /line /fly /fireworks /stop /say <msg> /calc <a+b|a/b> /auth <name> /unauth <name>"
