...
subtitle.Text = "Commands: /follow /stack [name] /side line /orbit /line /fly /fireworks /stop /funfact /say <msg> /calc <a+b|a/b> /auth <name> /unauth <name> /cmds"
...
local function processCommand(speaker, message)
	...
	elseif normalized == "/cmds" then
		sendChatMessage("/follow /stack [name] /side line /orbit /line /fly /fireworks /stop /funfact /say /calc /auth /unauth /cmds")
		return
